...
<div id="wrap">
    <header>
        ...
        <div class="account">
            <a href="View/create/registration.php">Inscription</a>
    ...
    <main>
        ...
        <a class="red linkMenuMobile" href="View/account.php">Compte</a>
    ...
    <footer class="flexRow">
        ...
        <div class="flexRow flexCenter content">
            ...
            <a class="colorWhite" href="View/contact.php">Contact</a>
        </div>
    </footer>
</div>
